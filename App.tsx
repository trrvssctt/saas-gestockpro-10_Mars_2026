...
import { WaveSuccessPage, WaveCancelPage } from './components/WaveRedirect';
...
const App: React.FC = () => {
  ...
  // ── Wave Checkout redirect pages ──────────────────────────────
  if (stripePathname === '/wave/success') {
    return <WaveSuccessPage onContinue={() => leaveStripePage('subscription')} />;
  }
  if (stripePathname === '/wave/cancel') {
    return <WaveCancelPage onRetry={() => leaveStripePage('subscription')} />;
  }
